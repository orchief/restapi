...
class QuickIdentityVerifyRequest extends TrxRequest {
	...
	protected function checkRequest() {
		...
		//增加手机号长度验证，与java保持一致  add by chj@20190307
	  if (strlen($this->request["MobileNo"])!==11) {
			throw new TrxException(TrxException :: TRX_EXC_CODE_1101, TrxException :: TRX_EXC_MSG_1101, "手机号长度不合法！");
		}
	}
}
?>
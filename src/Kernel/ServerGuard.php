...
use SDK\Kernel\Contracts\MessageInterface;
use SDK\Kernel\Exceptions\BadRequestException;
use SDK\Kernel\Exceptions\InvalidArgumentException;
use SDK\Kernel\Messages\Message;
use SDK\Kernel\Messages\News;
use SDK\Kernel\Messages\NewsItem;
use SDK\Kernel\Messages\Raw as RawMessage;
use SDK\Kernel\Messages\Text;
use SDK\Kernel\Support\XML;
use SDK\Kernel\Traits\Observable;
use SDK\Kernel\Traits\ResponseCastable;
...
class ServerGuard
{
     ...
     * @return $this
     *
     * @throws \SDK\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\SDK\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \SDK\Kernel\Exceptions\InvalidArgumentException
     * @throws \SDK\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \SDK\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \SDK\Kernel\Exceptions\InvalidArgumentException
     ...
     * @param string                                        $to
     * @param string                                        $from
     * @param \SDK\Kernel\Contracts\MessageInterface $message
     *
     * @return string
     */

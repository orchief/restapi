...
namespace SDK\OpenPlatform;

use SDK\Kernel\ServiceContainer;
use SDK\MiniProgram\Encryptor;
use SDK\OpenPlatform\Authorizer\Auth\AccessToken;
use SDK\OpenPlatform\Authorizer\MiniProgram\Application as MiniProgram;
use SDK\OpenPlatform\Authorizer\MiniProgram\Auth\Client;
use SDK\OpenPlatform\Authorizer\OfficialAccount\Application as OfficialAccount;
use SDK\OpenPlatform\Authorizer\OfficialAccount\OAuth\ComponentDelegate;
use SDK\OpenPlatform\Authorizer\Server\Guard;

/**
 * Class Application.
 *
 * @property \SDK\OpenPlatform\Server\Guard        $server
 * @property \SDK\OpenPlatform\Auth\AccessToken    $access_token
 * @property \SDK\OpenPlatform\CodeTemplate\Client $code_template
 *
...
class Application extends ServiceContainer
{
     ...
     * @param \SDK\OpenPlatform\Authorizer\Auth\AccessToken|null $accessToken
     *
     * @return \SDK\OpenPlatform\Authorizer\OfficialAccount\Application
     */
     ...
     * @param \SDK\OpenPlatform\Authorizer\Auth\AccessToken|null $accessToken
     *
     * @return \SDK\OpenPlatform\Authorizer\MiniProgram\Application
     */

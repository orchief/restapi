...
namespace SDK\OfficialAccount\Broadcasting;

use SDK\Kernel\BaseClient;
use SDK\Kernel\Contracts\MessageInterface;
use SDK\Kernel\Exceptions\RuntimeException;
use SDK\Kernel\Messages\Card;
use SDK\Kernel\Messages\Image;
use SDK\Kernel\Messages\Media;
use SDK\Kernel\Messages\Text;
use SDK\Kernel\Support\Arr;

/**
 * Class Client.
 *
 * @method \Psr\Http\Message\ResponseInterface|\SDK\Kernel\Support\Collection|array|object|string
